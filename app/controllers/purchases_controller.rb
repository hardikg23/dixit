class PurchasesController < ApplicationController
  ...
  private
    ...
    def purchase_params
      params.require(:purchase).permit(:entity_id, :description, :sale_type, :quantity, :amount, :amount_type, :payment_type, :conversion_rate, :per_carat_rate, :payment_date, :purchase_date, :invoice_number)
    end
